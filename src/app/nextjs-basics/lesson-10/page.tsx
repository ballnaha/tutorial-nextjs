    ...
    <Box sx={{
      ...
      <Box sx={{ mb: { xs: 3, sm: 4 } }}>
        ...
        <Typography variant="h2" component="h1" sx={{ fontSize: { xs: '1.8rem', sm: '2.5rem', md: '3rem' }, fontWeight: 600, mb: 2, lineHeight: 1.2, display: 'flex', alignItems: 'center', gap: 2 }}>
          <Store color="primary" sx={{ fontSize: { xs: '2.2rem', sm: '3rem' } }} />
        ...
        <Stack direction="row" spacing={1} sx={{ flexWrap: 'wrap', gap: 1, mb: 3, '& .MuiChip-root': { fontSize: { xs: '0.75rem', sm: '0.8rem' } } }}>
          <Chip icon={<Store />} label="Zustand Store" color="primary" size="small" />
          <Chip icon={<Memory />} label="Persist Middleware" color="secondary" size="small" />
          <Chip icon={<Speed />} label="DevTools" color="info" size="small" />
          <Chip icon={<Code />} label="TypeScript" color="success" size="small" />
        </Stack>
      ...
      <Paper sx={{ mb: { xs: 3, sm: 4 } }}>
        ...
        >
          <Tab label="🚀 Zustand คืออะไร?" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' } }} />
          <Tab label="📦 การติดตั้ง" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' } }} />
          <Tab label="🏪 Store พื้นฐาน" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' } }} />
          <Tab label="🔄 Actions & Updates" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' } }} />
          <Tab label="💾 Persist Middleware" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' } }} />
          <Tab label="🛠️ DevTools" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' } }} />
